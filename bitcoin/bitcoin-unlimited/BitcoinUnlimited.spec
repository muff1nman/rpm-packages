...
Source0:	http://github.com/gandrewstone/%{name}/archive/%{version}.tar.gz
...
Patch1:	bitcoin-0.11.1-openssl-ec-h-configure.patch

# Check for existence of LibreSSL is broken, remove it
# We don't actually build with LibreSSL
Patch2: bitcoin-0.11.1-broken-libressl-check.patch
...
Conflicts:  bitcoinxt bitcoin


%package libs
Summary:	Peer-to-peer digital currency
Conflicts:  bitcoinxt-libs bitcoin-libs


%package devel
Summary:	Peer-to-peer digital currency
Requires:	BitcoinUnlimited-libs%{?_isa} = %{version}-%{release}
Conflicts:  bitcoinxt-devel bitcoin-devel
...
Conflicts:  bitcoinxt-utils bitcoin-utils
...
%endif
Requires:	BitcoinUnlimited-utils%{_isa} = %{version}
Conflicts:  bitcoinxt-server bitcoin-server
...
%build
# Replace Bitcoin Core icon with Bitcoin Unlimited icon
...
sed -i 's/Name=Bitcoin/Name=Bitcoin Unlimited/' contrib/debian/bitcoin-qt.desktop
...
%changelog
* Sat Jan 09 2016 Andrew DeMaria <lostonamountain@gmail.com> 82fd77550aa0e62c2f2ec2fb747bfcafb433013f-3
- Removed extraneous patch (lostonamountain@gmail.com)
