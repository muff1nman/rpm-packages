...
Source0:	https://github.com/bitcoinclassic/bitcoinclassic/archive/v%{version}.tar.gz
...
Patch1: bitcoin-0.11.0-destchange.patch

# Check for existence of LibreSSL is broken, remove it
# We don't actually build with LibreSSL
Patch2: bitcoinclassic-0.11.2-broken-libressl-check.patch
...
Conflicts:	bitcoin bitcoinxt


%package libs
Summary:	Peer-to-peer digital currency
Conflicts:	bitcoin-libs bitcoinxt-libs


%package devel
Summary:	Peer-to-peer digital currency
Requires:	bitcoinclassic-libs%{?_isa} = %{version}-%{release}
Conflicts:	bitcoin-devel bitcoinxt-devel
...
Conflicts:	bitcoin-utils bitcoinxt-utils
...
%endif
Requires:	bitcoinclassic-utils%{_isa} = %{version}
Conflicts:  	bitcoin-server bitcoinxt-server
...
%prep
%setup -q -n bitcoinclassic-%{version}
%patch1 -p1
%patch2 -p1
...
%build
# Replace Bitcoin Core icon with Bitcoin Classic icon
...
sed -i 's/Name=Bitcoin/Name=Bitcoin Classic/' contrib/debian/bitcoin-qt.desktop
...
%changelog
* Wed Feb 10 2016 Andrew DeMaria <lostonamountain@gmail.com> 0.11.2.cl1-4
- Updated version number (lostonamountain@gmail.com)
